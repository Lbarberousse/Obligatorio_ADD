...
# Rellenar Gender usando un clasificador Bayesiano en base a la altura
...
X_train = df.loc[mask_valid, ['Height']]
...
X_test = df.loc[mask_pred, ['Height']]
X_test_scaled = scaler.transform(X_test)

df.loc[mask_pred, 'Gender'] = nb_model.predict(X_test_scaled)
